...
from model.base.components import SPPF
...
class SwinBackbone(nn.Module):
    ...
    def __init__(self, w, r, n):
        ...
        # Stage1: Embedding + SwinStage
        self.stage1 = nn.Sequential(
            PatchEmbed(
                in_c=self.imageChannel, 
        ...
        # Stage4: PatchMerging + SwinStage + SPPF
        self.stage4 = nn.Sequential(
            ...
            SPPF(self.channels[3], self.channels[3], 5)
        )
    ...
    def forward(self, x):
        ...
        """
        # Stage1: (B, 3, 640, 640) -> (B, 128*w, 160, 160)
        feat0 = self.stage1(x)
        
        # Stage2: (B, 128*w, 160, 160) -> (B, 256*w, 80, 80)
        feat1 = self.stage2(feat0)

        # Stage3: (B, 256*w, 80, 80) -> (B, 512*w, 40, 40)
        feat2 = self.stage3(feat1)
        
        # Stage4: (B, 512*w, 40, 40) -> (B, 512*w*r, 20, 20)
